...
const es: Translations = {
  ...
  missesSection: '❌ Lanzamiento', errorShot: 'Error', errFly: 'Err Fly',
  missedShot: 'Fallo de Lanzamiento',
  ...
  selectGoalkeeper: 'Selección de Portero',
  chooseShooter: 'Elige qué jugador va a lanzar:',
  chooseGoalkeeper: 'Elige quién defiende la portería:',
  alreadyShot: '(Lanzó)',
  // Analytics
...
const ca: Translations = {
  ...
  defense:'🟢 Defensa',recover:'Recuperar',
  missesSection:'❌ Llançament',errorShot:'Error',errFly:'Err Fly',
  missedShot:'Fallada de Llançament',
  ...
  selectShooter:'Selecció de Tirador',selectGoalkeeper:'Selecció de Porter',
  chooseShooter:'Tria quin jugador llançarà:',chooseGoalkeeper:'Tria qui defensa la porteria:',alreadyShot:'(Llançat)',
...
const en: Translations = {
  ...
  missesSection:'❌ Shot',errorShot:'Miss',errFly:'Fly Miss',
  ...
  selectShooter:'Select Shooter',selectGoalkeeper:'Select Goalkeeper',
  chooseShooter:'Choose which player will shoot:',chooseGoalkeeper:'Choose who defends the goal:',alreadyShot:'(Shot)',
